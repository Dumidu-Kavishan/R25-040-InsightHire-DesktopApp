...
class AlertManager:
        ...
        try:
            ...
            if bad_posture_percentage > threshold:
                ...
                if self._can_trigger_alert('bad_posture', cooldown):
                    ...
                    logger.warning(f"[ALERT] Bad posture alert triggered: {bad_posture_percentage:.1f}% (threshold: {threshold}%)")
                else:
    ...
    def trigger_immediate_posture_alert(self, bad_posture_percentage, context_data=None):
        ...
        try:
            ...
            logger.warning(f"[ALERT] Immediate posture alert triggered: {bad_posture_percentage:.1f}%")
        ...
        try:
            ...
            if avg_blink_count > high_threshold and high_blink_percentage > 60:
                ...
                if self._can_trigger_alert('high_blink_rate', cooldown):
                    ...
                    logger.warning(f"[ALERT] High blink rate alert triggered: {avg_blink_count:.1f} blinks/min (threshold: {high_threshold})")
                else:
            ...
            if avg_blink_count < low_threshold and low_blink_percentage > 60:
                ...
                if self._can_trigger_alert('low_blink_rate', cooldown):
                    ...
                    logger.warning(f"[ALERT] Low blink rate alert triggered: {avg_blink_count:.1f} blinks/min (threshold: {low_threshold})")
                else:
    ...
    def trigger_immediate_cvs_alert(self, blink_count, is_high=True, context_data=None):
        ...
        try:
            ...
            logger.warning(f"[ALERT] Immediate CVS alert triggered: {blink_count:.1f} blinks/min ({alert_type})")
        ...
        try:
            ...
            if dry_lips_percentage > threshold:
                ...
                if self._can_trigger_alert('dry_lips', cooldown):
                    ...
                    logger.warning(f"[ALERT] Hydration alert triggered: {dry_lips_percentage:.1f}% dry lips (threshold: {threshold}%)")
                else:
    ...
    def trigger_immediate_hydration_alert(self, dry_lips_percentage, context_data=None):
        ...
        try:
            ...
            logger.warning(f"[ALERT] Immediate hydration alert triggered: {dry_lips_percentage:.1f}% dry lips")
